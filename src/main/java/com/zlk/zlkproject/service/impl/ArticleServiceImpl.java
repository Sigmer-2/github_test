...
//import com.zlk.zlkproject.enums.ArticleCommentStatus;
import com.zlk.zlkproject.mapper.ArticleCategoryRefMapper;
import com.zlk.zlkproject.mapper.ArticleMapper;
import com.zlk.zlkproject.mapper.ArticleTagRefMapper;
import com.zlk.zlkproject.mapper.CategoryMapper;
import com.zlk.zlkproject.service.ArticleService;
...
//            articleList.get(i).setTagList(tagList);
    ...
    @Override
    public PageInfo<Article> pageArticle1(Integer pageIndex,Integer pageSize,HashMap<String, Object> criteria) {
...
//            articleList.get(i).setTagList(tagList);
    ...
    public Article getArticleByStatusAndId(Integer status, Integer id) {
        ...
        if (article != null) {
            List<Category> categoryList = categoryMapper.listCategoryByArticleId(article.getArticleId());
